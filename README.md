...
- **Solution**: 
  ...
  3. Delete `data/clinic.db` and restart
...
3. **Run Application**: Use `mvn javafx:run` in the `Clinicly-main` folder
4. **Login**: Use default credentials (must change password on first login)
